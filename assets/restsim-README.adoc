...
Make sure to included all ingredients from <<menu.txt, `menu.txt`>>.
Use the format:
....
[{
...
You can automatically upload inventory shipments from <<inventory-receipts.txt,  `inventory-receipts.txt`>>.
